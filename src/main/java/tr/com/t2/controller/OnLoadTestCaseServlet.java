 ...
 * @author Arda
 */
public class OnLoadTestCaseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String testSuiteInfo = request.getParameter("testSuiteInfo");
        ObjectMapper mapper = new ObjectMapper();
        T2TFTestSuite newSuite = mapper.readValue(testSuiteInfo, T2TFTestSuite.class);
        List<T2TFTestCase> allCases =  userService.getTestSuitesTestCases(newSuite);

        
    Gson gson = new Gson();
String json = gson.toJson(allCases);
