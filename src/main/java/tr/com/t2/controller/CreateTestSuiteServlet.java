 ...
 * @author Arda
 */
public class CreateTestSuiteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        T2TFTestSuite newTestSuite = mapper.readValue(projectInfo, T2TFTestSuite.class);
        userService.createTestSuite(newTestSuite);
