...
public class DeleteTestCaseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String testCaseInfo = request.getParameter("testCaseInfo");
        ObjectMapper mapper = new ObjectMapper();
        T2TFTestCase newTestCase = mapper.readValue(testCaseInfo, T2TFTestCase.class);
        userService.deleteTestCase(newTestCase);
