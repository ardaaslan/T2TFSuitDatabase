 ...
 * @author Arda
 */
public class OnLoadTestSuiteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<T2TFTestSuite> allSuites =  userService.getProjectsTestSuites(newProject);

        
    Gson gson = new Gson();
String json = gson.toJson(allSuites);
